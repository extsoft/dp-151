...
class ContactUsPage(Page):
    def __init__(self, browser: Remote) -> None:
        ...
        self._email_field = PersonalDetails(browser)
    ...
    def fill_contact_details(self, your_name: str, email: str, enquiry: str) -> None:
        ...
        self._email_field.type_email(email)
...
class ContactUsSuccessPage(Page):
    ...
    def loaded(self) -> bool:
        return "http://localhost/index.php?route=" \
               "information/contact/success" in self._browser.current_url
